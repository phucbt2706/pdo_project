                        ...
                        <form action="index.php" method="post" enctype="multipart/form-data">
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="" class="form-control" readonly value="<?php echo $ma_kh; ?>" name="ma_kh">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="" class="form-control" id="" value="<?php echo $ten_kh; ?>" name="ten_kh">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="password" class="form-control" id="inputPassword4" value="<?php echo $mat_khau; ?>" name="mat_khau">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="password" class="form-control" id="inputPassword4" value="<?php echo $mat_khau; ?>" name="mat_khau2">
                                    <span id="red_error" class="form-text"><?php if (!empty($error['password_format'])) {
                                                            echo $error['password_format'];
                                                        } else if (!empty($error['password_empty'])) {
                                                            echo $error['password_empty'];
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="email" name="email" class="form-control" value="<?php echo $email; ?>" id="exampleFormControlInput1" placeholder="name@example.com">
